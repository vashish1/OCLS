...
const currentTime = moment(yourDate, 'DD-MM-YYYY')
const CreateAnnouncement = () => {
    ...
    const handleAnnouncement= async ()=>{
        let item={teacherName,classCode,desc,currentTime};
    ...
    return (
        ...
        <Grid>
            <Paper  style={paperStyle}>
                ...
                <Button type='submit' onClick={handleAnnouncement} color='primary' variant="contained" style={btnstyle} fullWidth>Create Announcement</Button>
