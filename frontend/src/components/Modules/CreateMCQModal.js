...
export default function CreateMCQModal() {
  ...
  const body = userType==1?(
    <div style={modalStyle} className={classes.paper}>
      <h2 id="simple-modal-title">`${currentClass}`</h2>
     ...
     <label htmlFor="contained-button-file">
      ...
      <Button type='submit' onClick={handleSubmitAssignment} color='primary' variant="contained" style={btnstyle} fullWidth>Create Assignment</Button>
    </div>
  ):(<div style={modalStyle} className={classes.paper}>
    <h2 id="simple-modal-title">Submit Assignment</h2>
     ...
     onChange={handleImageAsFile}
   />
    <Button type='submit' onClick={handleCreateAssignment} color='primary' variant="contained" style={btnstyle} fullWidth>Submit Assignment</Button>
  </div>);
